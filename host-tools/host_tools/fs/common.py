...
BFS_DIRENT_INO_OFFSET = 0
BFS_DIRENT_SBLOCK_OFFSET = 4
BFS_DIRENT_EBLOCK_OFFSET = 8
BFS_DIRENT_EOFFSET_OFFSET = 12
BFS_DIRENT_VATTR_OFFSET = 16

BFS_VATTR_TYPE_OFFSET = 0
BFS_VATTR_MODE_OFFSET = 4
BFS_VATTR_UID_OFFSET = 8
BFS_VATTR_GID_OFFSET = 12
BFS_VATTR_NLINK_OFFSET = 16
BFS_VATTR_ATIME_OFFSET = 20
BFS_VATTR_MTIME_OFFSET = 24
BFS_VATTR_CTIME_OFFSET = 28
