...
PACKAGE_SOURCE_RULES: dict[str, list[dict[str, object]]] = {
    ...
    "cmux": [{"source_root": "arch/at/uts/i386/io", "output_root": "io/core", "patterns": ["chanmux.c"]}],
    ...
    "gvid": [{"source_root": "arch/at/uts/i386/io", "output_root": "io/core", "patterns": ["genvid.c"]}],
    ...
    "kd": [{"source_root": "arch/at/uts/i386/io/kd", "output_root": "io/kd", "patterns": ["*.c"]}],
    "kdvm": [{"source_root": "arch/at/uts/i386/io/kdvm", "output_root": "io/kdvm", "patterns": ["*.c"]}],
...
def _device_major_end(devices: list[DeviceSpec], flag: str) -> int:
    high = -1
    for device in devices:
        if flag == "b" and device.block_major_end is not None:
            high = max(high, device.block_major_end)
        if flag == "c" and device.char_major_end is not None:
